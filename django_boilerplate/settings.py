...
SECRET_KEY = config(
    "DJANGO_SECRET_KEY",
    default="django-insecure-akv%f-vo6*c+msrjrjn^+nmi8%ruvo0#e!8(5yq097ag@ab#4%",
)
...
DATABASES = {
    "default": {
        ...
        "NAME": config("DB_NAME", default="your_db"),
        "USER": config("DB_USER", default="your_user"),
        "PASSWORD": config("DB_PASSWORD", default="your_pass"),
